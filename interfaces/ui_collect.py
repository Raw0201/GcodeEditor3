...
class Ui_frm_collect(object):
    def setupUi(self, frm_collect):
        if not frm_collect.objectName():
            frm_collect.setObjectName("frm_collect")
    ...
    def retranslateUi(self, frm_collect):
        frm_collect.setWindowTitle(
            QCoreApplication.translate("frm_collect", "GCode Editor", None)
        )
        self.lbl_clt.setText(
            QCoreApplication.translate("frm_collect", "Recolecci\u00f3n de pieza", None)
        )
        # if QT_CONFIG(tooltip)
        self.cbx_clt.setToolTip(
            QCoreApplication.translate(
                "frm_collect", "Seleccione el modo de recolecci\u00f3n de pieza", None
            )
        )
        ...
        self.btn_save.setToolTip(
            QCoreApplication.translate(
                "frm_collect", "Agregar los datos al programa CNC", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.btn_save.setText(
            QCoreApplication.translate("frm_collect", "Agregar", None)
        )
        # if QT_CONFIG(shortcut)
        self.btn_save.setShortcut(
            QCoreApplication.translate("frm_collect", "Ctrl+S", None)
        )
        # endif // QT_CONFIG(shortcut)
        self.btn_help.setText("")
        # if QT_CONFIG(shortcut)
        self.btn_help.setShortcut(QCoreApplication.translate("frm_collect", "F1", None))
