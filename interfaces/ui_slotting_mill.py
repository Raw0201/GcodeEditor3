...
################################################################################
## Form generated from reading UI file 'slotting_millrmYnif.ui'
##
...
class Ui_frm_slotting_mill(object):
    def setupUi(self, frm_slotting_mill):
        if not frm_slotting_mill.objectName():
            frm_slotting_mill.setObjectName("frm_slotting_mill")
        frm_slotting_mill.resize(210, 580)
        sizePolicy = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(frm_slotting_mill.sizePolicy().hasHeightForWidth())
        frm_slotting_mill.setSizePolicy(sizePolicy)
        frm_slotting_mill.setMinimumSize(QSize(210, 580))
        frm_slotting_mill.setMaximumSize(QSize(360, 580))
        icon = QIcon()
        icon.addFile(":/icons/gear.png", QSize(), QIcon.Normal, QIcon.Off)
        frm_slotting_mill.setWindowIcon(icon)
        frm_slotting_mill.setStyleSheet(
            "/* ---------------------------------------------------------------------------\n"
            "\n"
        ...
        self.centralwidget = QWidget(frm_slotting_mill)
        ...
        self.tbx_dpt.setGeometry(QRect(13, 30, 170, 26))
        ...
        self.lbl_dpt.setGeometry(QRect(15, 10, 141, 26))
        self.lbl_dir = QLabel(self.frame)
        self.lbl_dir.setObjectName("lbl_dir")
        self.lbl_dir.setEnabled(True)
        self.lbl_dir.setGeometry(QRect(15, 360, 125, 26))
        self.cbx_dir = QComboBox(self.frame)
        self.cbx_dir.setObjectName("cbx_dir")
        self.cbx_dir.setGeometry(QRect(13, 380, 170, 26))
        self.cbx_dir.setMinimumSize(QSize(170, 26))
        self.cbx_dir.setMaximumSize(QSize(170, 16777215))
        ...
        self.tbx_lgt.setObjectName("tbx_lgt")
        ...
        self.lbl_lgt.setGeometry(QRect(15, 60, 124, 26))
        ...
        self.tbx_fed.setGeometry(QRect(13, 180, 170, 26))
        ...
        self.tbx_lcm.setObjectName("tbx_lcm")
        self.tbx_lcm.setGeometry(QRect(13, 430, 170, 26))
        ...
        self.lbl_lcm.setObjectName("lbl_lcm")
        self.lbl_lcm.setEnabled(True)
        self.lbl_lcm.setGeometry(QRect(15, 410, 155, 26))
        self.tbx_tcm = QLineEdit(self.frame)
        self.tbx_tcm.setObjectName("tbx_tcm")
        self.tbx_tcm.setGeometry(QRect(13, 480, 170, 26))
        ...
        self.lbl_tcm.setObjectName("lbl_tcm")
        self.lbl_tcm.setEnabled(True)
        self.lbl_tcm.setGeometry(QRect(15, 460, 141, 26))
        self.tbx_ang = QLineEdit(self.frame)
        self.tbx_ang.setObjectName("tbx_ang")
        self.tbx_ang.setGeometry(QRect(13, 230, 170, 26))
        ...
        self.lbl_ang.setGeometry(QRect(15, 210, 111, 26))
        self.cbx_pos = QComboBox(self.frame)
        self.cbx_pos.setObjectName("cbx_pos")
        self.cbx_pos.setGeometry(QRect(13, 330, 170, 26))
        ...
        self.lbl_pos.setGeometry(QRect(12, 310, 121, 26))
        self.tbx_dim = QLineEdit(self.frame)
        self.tbx_dim.setObjectName("tbx_dim")
        self.tbx_dim.setGeometry(QRect(13, 280, 170, 26))
        ...
        self.lbl_dim.setObjectName("lbl_dim")
        self.lbl_dim.setEnabled(True)
        self.lbl_dim.setGeometry(QRect(15, 260, 121, 26))
        self.tbx_dpt.raise_()
        self.lbl_dpt.raise_()
        self.cbx_dir.raise_()
        self.lbl_dir.raise_()
        ...
        frm_slotting_mill.setCentralWidget(self.centralwidget)
        # if QT_CONFIG(shortcut)
        self.lbl_dpt.setBuddy(self.lbl_dpt)
        self.lbl_dir.setBuddy(self.lbl_dir)
        self.lbl_lgt.setBuddy(self.lbl_dpt)
        self.lbl_cut.setBuddy(self.lbl_dpt)
        self.lbl_fed.setBuddy(self.lbl_dpt)
        self.lbl_lcm.setBuddy(self.lbl_dpt)
        self.lbl_tcm.setBuddy(self.lbl_dpt)
        self.lbl_ang.setBuddy(self.lbl_dpt)
        self.lbl_pos.setBuddy(self.lbl_dir)
        self.lbl_dim.setBuddy(self.lbl_dpt)
        # endif // QT_CONFIG(shortcut)
        QWidget.setTabOrder(self.tbx_dpt, self.tbx_lgt)
        QWidget.setTabOrder(self.tbx_lgt, self.tbx_cut)
        QWidget.setTabOrder(self.tbx_cut, self.tbx_fed)
        QWidget.setTabOrder(self.tbx_fed, self.tbx_ang)
        QWidget.setTabOrder(self.tbx_ang, self.tbx_dim)
        QWidget.setTabOrder(self.tbx_dim, self.cbx_pos)
        QWidget.setTabOrder(self.cbx_pos, self.cbx_dir)
        QWidget.setTabOrder(self.cbx_dir, self.tbx_lcm)
        QWidget.setTabOrder(self.tbx_lcm, self.tbx_tcm)
        QWidget.setTabOrder(self.tbx_tcm, self.btn_save)
        QWidget.setTabOrder(self.btn_save, self.btn_help)

        self.retranslateUi(frm_slotting_mill)

        QMetaObject.connectSlotsByName(frm_slotting_mill)

    # setupUi

    def retranslateUi(self, frm_slotting_mill):
        frm_slotting_mill.setWindowTitle(
            QCoreApplication.translate("frm_slotting_mill", "GCode Editor", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_dpt.setToolTip(
            QCoreApplication.translate(
                "frm_slotting_mill", "Digite el texto del comentario", None
            )
        )
        ...
        self.lbl_dpt.setText(
            QCoreApplication.translate(
                "frm_slotting_mill", "Profundidad de la ranura", None
            )
        )
        self.lbl_dir.setText(
            QCoreApplication.translate(
                "frm_slotting_mill", "Direcci\u00f3n de los cortes", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.cbx_dir.setToolTip(
            QCoreApplication.translate(
                "frm_slotting_mill", "Seleccione el husillo de trabajo a utilizar", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        self.btn_save.setToolTip(
            QCoreApplication.translate(
                "frm_slotting_mill", "Agregar los datos al programa CNC", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.btn_save.setText(
            QCoreApplication.translate("frm_slotting_mill", "Agregar", None)
        )
        # if QT_CONFIG(shortcut)
        self.btn_save.setShortcut(
            QCoreApplication.translate("frm_slotting_mill", "Ctrl+S", None)
        )
        # endif // QT_CONFIG(shortcut)
        # if QT_CONFIG(tooltip)
        self.tbx_lgt.setToolTip(
            QCoreApplication.translate(
                "frm_slotting_mill", "Digite el texto del comentario", None
            )
        )
        ...
        self.lbl_lgt.setText(
            QCoreApplication.translate(
                "frm_slotting_mill", "Longitud de la ranura", None
            )
        )
        # if QT_CONFIG(tooltip)
        ...
        self.lbl_cut.setText(
            QCoreApplication.translate(
                "frm_slotting_mill", "Profundidad por corte", None
            )
        )
        # if QT_CONFIG(tooltip)
        ...
        # endif // QT_CONFIG(statustip)
        self.tbx_fed.setText("")
        self.tbx_fed.setPlaceholderText("")
        self.lbl_fed.setText(
            QCoreApplication.translate("frm_slotting_mill", "Avance de corte", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_lcm.setToolTip(
            QCoreApplication.translate(
                "frm_slotting_mill", "Digite el texto del comentario", None
            )
        )
        ...
        # endif // QT_CONFIG(statustip)
        self.tbx_lcm.setText(QCoreApplication.translate("frm_slotting_mill", "0", None))
        self.tbx_lcm.setPlaceholderText("")
        self.lbl_lcm.setText(
            QCoreApplication.translate(
                "frm_slotting_mill", "Compensaci\u00f3n longitudinal", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.tbx_tcm.setToolTip(
            QCoreApplication.translate(
                "frm_slotting_mill", "Digite el texto del comentario", None
            )
        )
        ...
        # endif // QT_CONFIG(statustip)
        self.tbx_tcm.setText(QCoreApplication.translate("frm_slotting_mill", "0", None))
        self.tbx_tcm.setPlaceholderText("")
        self.lbl_tcm.setText(
            QCoreApplication.translate(
                "frm_slotting_mill", "Compensaci\u00f3n trasversal", None
            )
        )
        # if QT_CONFIG(tooltip)
        ...
        # endif // QT_CONFIG(statustip)
        self.tbx_ang.setText(QCoreApplication.translate("frm_slotting_mill", "0", None))
        self.tbx_ang.setPlaceholderText("")
        self.lbl_ang.setText(
            QCoreApplication.translate(
                "frm_slotting_mill", "\u00c1ngulo de la ranura", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.cbx_pos.setToolTip(
            QCoreApplication.translate(
                "frm_slotting_mill", "Seleccione el husillo de trabajo a utilizar", None
            )
        )
        ...
        self.lbl_pos.setText(
            QCoreApplication.translate(
                "frm_slotting_mill", "Posici\u00f3n de la ranura", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.tbx_dim.setToolTip(
            QCoreApplication.translate(
                "frm_slotting_mill", "Digite el texto del comentario", None
            )
        )
        ...
        self.lbl_dim.setText(
            QCoreApplication.translate(
                "frm_slotting_mill", "Di\u00e1metro de la punta", None
            )
        )
        self.btn_help.setText("")
        # if QT_CONFIG(shortcut)
        self.btn_help.setShortcut(
            QCoreApplication.translate("frm_slotting_mill", "F1", None)
        )
