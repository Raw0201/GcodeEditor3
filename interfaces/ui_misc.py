...
class Ui_frm_misc(object):
    def setupUi(self, frm_misc):
        if not frm_misc.objectName():
            frm_misc.setObjectName("frm_misc")
        ...
        self.cbx_chk.setObjectName("cbx_chk")
        ...
        self.cbx_stp.setObjectName("cbx_stp")
        ...
        self.cbx_pln.setObjectName("cbx_pln")
        ...
        self.lbl_pln.setObjectName("lbl_pln")
    ...
    def retranslateUi(self, frm_misc):
        frm_misc.setWindowTitle(
            QCoreApplication.translate("frm_misc", "GCode Editor", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_com.setToolTip(
            QCoreApplication.translate(
                "frm_misc", "Digite el texto del comentario", None
            )
        )
        ...
        self.lbl_com.setText(
            QCoreApplication.translate("frm_misc", "C\u00f3digo libre", None)
        )
        self.lbl_chk.setText(QCoreApplication.translate("frm_misc", "Boquilla", None))
        # if QT_CONFIG(tooltip)
        self.cbx_chk.setToolTip(
            QCoreApplication.translate(
                "frm_misc", "Seleccione la boquilla y tarea a ejecutar", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        self.btn_save.setToolTip(
            QCoreApplication.translate(
                "frm_misc", "Agregar los datos al programa CNC", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        # endif // QT_CONFIG(statustip)
        self.btn_save.setText(QCoreApplication.translate("frm_misc", "Agregar", None))
        # if QT_CONFIG(shortcut)
        self.btn_save.setShortcut(
            QCoreApplication.translate("frm_misc", "Ctrl+S", None)
        )
        # endif // QT_CONFIG(shortcut)
        # if QT_CONFIG(tooltip)
        self.cbx_stp.setToolTip(
            QCoreApplication.translate(
                "frm_misc", "Seleccione el tipo de parada de programa", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.lbl_stp.setText(
            QCoreApplication.translate("frm_misc", "Detener programa", None)
        )
        # if QT_CONFIG(tooltip)
        self.cbx_col.setToolTip(
            QCoreApplication.translate(
                "frm_misc", "Seleccione la tarea a ejecutar para el refrigerante", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.lbl_col.setText(
            QCoreApplication.translate("frm_misc", "Refrigerante", None)
        )
        # if QT_CONFIG(tooltip)
        self.cbx_sde.setToolTip(
            QCoreApplication.translate(
                "frm_misc", "Seleccione el husillo de trabajo a utilizar", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.lbl_sde.setText(
            QCoreApplication.translate("frm_misc", "Husillo de trabajo", None)
        )
        # if QT_CONFIG(tooltip)
        self.cbx_pln.setToolTip(
            QCoreApplication.translate(
                "frm_misc", "Seleccione el plano de trabajo a utilizar", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.lbl_pln.setText(
            QCoreApplication.translate("frm_misc", "Plano de trabajo", None)
        )
        self.btn_help.setText("")
        # if QT_CONFIG(shortcut)
        self.btn_help.setShortcut(QCoreApplication.translate("frm_misc", "F1", None))
