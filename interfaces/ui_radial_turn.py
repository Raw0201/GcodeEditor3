...
################################################################################
## Form generated from reading UI file 'radial_turnYDglNo.ui'
##
...
class Ui_frm_radial_turn(object):
    def setupUi(self, frm_radial_turn):
        if not frm_radial_turn.objectName():
            frm_radial_turn.setObjectName("frm_radial_turn")
    ...
    def retranslateUi(self, frm_radial_turn):
        frm_radial_turn.setWindowTitle(
            QCoreApplication.translate("frm_radial_turn", "GCode Editor", None)
        )
        ...
        self.lbl_xin.setText(
            QCoreApplication.translate("frm_radial_turn", "Movimiento eje X", None)
        )
        # if QT_CONFIG(tooltip)
        self.btn_save.setToolTip(
            QCoreApplication.translate(
                "frm_radial_turn", "Agregar los datos al programa CNC", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.btn_save.setText(
            QCoreApplication.translate("frm_radial_turn", "Agregar", None)
        )
        # if QT_CONFIG(shortcut)
        self.btn_save.setShortcut(
            QCoreApplication.translate("frm_radial_turn", "Ctrl+S", None)
        )
        # endif // QT_CONFIG(shortcut)
        self.lbl_mov.setText(
            QCoreApplication.translate("frm_radial_turn", "Sentido de giro", None)
        )
        # if QT_CONFIG(tooltip)
        self.cbx_mov.setToolTip(
            QCoreApplication.translate(
                "frm_radial_turn", "Seleccione el tipo de movimiento a ejecutar", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        self.cbx_sde.setToolTip(
            QCoreApplication.translate(
                "frm_radial_turn", "Seleccione el husillo de trabajo a utilizar", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.lbl_sde.setText(
            QCoreApplication.translate("frm_radial_turn", "Husillo de trabajo", None)
        )
        # if QT_CONFIG(tooltip)
        ...
        self.lbl_zin.setText(
            QCoreApplication.translate("frm_radial_turn", "Movimiento eje Z", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_fed.setToolTip(
            QCoreApplication.translate(
                "frm_radial_turn", "Digite la velocidad de avance de corte", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.lbl_fed.setText(
            QCoreApplication.translate("frm_radial_turn", "Avance de corte", None)
        )
        # if QT_CONFIG(tooltip)
        self.btn_switch.setToolTip(
            QCoreApplication.translate(
                "frm_radial_turn", "Cambia a la funci\u00f3n indicada", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.btn_switch.setText(
            QCoreApplication.translate(
                "frm_radial_turn", "Cambiar a Torneado lineal", None
            )
        )
        # if QT_CONFIG(shortcut)
        self.btn_switch.setShortcut(
            QCoreApplication.translate("frm_radial_turn", "Ctrl+Q", None)
        )
        # endif // QT_CONFIG(shortcut)
        # if QT_CONFIG(tooltip)
        ...
        self.lbl_xcn.setText(
            QCoreApplication.translate(
                "frm_radial_turn", "Radio / Punto centro X", None
            )
        )
        # if QT_CONFIG(tooltip)
        ...
        self.lbl_zcn.setText(
            QCoreApplication.translate("frm_radial_turn", "Punto centro Z", None)
        )
        self.btn_help.setText("")
        # if QT_CONFIG(shortcut)
        self.btn_help.setShortcut(
            QCoreApplication.translate("frm_radial_turn", "F1", None)
        )
