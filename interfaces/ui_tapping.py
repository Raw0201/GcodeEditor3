...
################################################################################
## Form generated from reading UI file 'tappingkAFwhP.ui'
##
...
class Ui_frm_tapping(object):
    def setupUi(self, frm_tapping):
        if not frm_tapping.objectName():
            frm_tapping.setObjectName("frm_tapping")
        ...
        self.cbx_thd.setObjectName("cbx_thd")
        ...
        self.lbl_thd.setObjectName("lbl_thd")
    ...
    def retranslateUi(self, frm_tapping):
        frm_tapping.setWindowTitle(
            QCoreApplication.translate("frm_tapping", "GCode Editor", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_dpt.setToolTip(
            QCoreApplication.translate(
                "frm_tapping", "Digite la profundidad del agujero", None
            )
        )
        ...
        self.lbl_dpt.setText(
            QCoreApplication.translate("frm_tapping", "Profundidad de la rosca", None)
        )
        # if QT_CONFIG(tooltip)
        self.btn_save.setToolTip(
            QCoreApplication.translate(
                "frm_tapping", "Agregar los datos al programa CNC", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.btn_save.setText(
            QCoreApplication.translate("frm_tapping", "Agregar", None)
        )
        # if QT_CONFIG(shortcut)
        self.btn_save.setShortcut(
            QCoreApplication.translate("frm_tapping", "Ctrl+S", None)
        )
        # endif // QT_CONFIG(shortcut)
        # if QT_CONFIG(tooltip)
        self.cbx_sde.setToolTip(
            QCoreApplication.translate(
                "frm_tapping", "Seleccione el husillo de trabajo a utilizar", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.lbl_sde.setText(
            QCoreApplication.translate("frm_tapping", "Husillo de trabajo", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_xin.setToolTip(
            QCoreApplication.translate(
                "frm_tapping", "Digite la posici\u00f3n de inicio en el eje X", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        # endif // QT_CONFIG(statustip)
        self.tbx_xin.setText(QCoreApplication.translate("frm_tapping", "0.0", None))
        self.tbx_xin.setPlaceholderText("")
        self.lbl_xin.setText(
            QCoreApplication.translate("frm_tapping", "Posici\u00f3n inicio X", None)
        )
        self.lbl_yin.setText(
            QCoreApplication.translate("frm_tapping", "Posici\u00f3n inicio Y", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_yin.setToolTip(
            QCoreApplication.translate(
                "frm_tapping", "Digite la posici\u00f3n de inicio en el eje Y", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        # endif // QT_CONFIG(statustip)
        self.tbx_yin.setText(QCoreApplication.translate("frm_tapping", "0.0", None))
        self.tbx_yin.setPlaceholderText("")
        self.lbl_zin.setText(
            QCoreApplication.translate("frm_tapping", "Posici\u00f3n inicio Z", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_zin.setToolTip(
            QCoreApplication.translate(
                "frm_tapping", "Digite la posici\u00f3n de inicio en el eje Z", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        # endif // QT_CONFIG(statustip)
        self.tbx_zin.setText(QCoreApplication.translate("frm_tapping", "0.0", None))
        self.tbx_zin.setPlaceholderText("")
        # if QT_CONFIG(tooltip)
        self.cbx_sys.setToolTip(
            QCoreApplication.translate(
                "frm_tapping", "Seleccione el sistema de coordenadas a utilizar", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.lbl_sys.setText(
            QCoreApplication.translate("frm_tapping", "Sistema de coordenadas", None)
        )
        self.lbl_znd.setText(
            QCoreApplication.translate("frm_tapping", "Posici\u00f3n de salida", None)
        )
        # if QT_CONFIG(tooltip)
        self.cbx_znd.setToolTip(
            QCoreApplication.translate(
                "frm_tapping", "Seleccione el punto de salida del perforado", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        self.tbx_rtr.setToolTip(
            QCoreApplication.translate(
                "frm_tapping", "Digite la distancia de retracci\u00f3n", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        # endif // QT_CONFIG(statustip)
        self.tbx_rtr.setText(QCoreApplication.translate("frm_tapping", "0.0", None))
        self.tbx_rtr.setPlaceholderText("")
        self.lbl_rtr.setText(
            QCoreApplication.translate("frm_tapping", "Punto de retracci\u00f3n", None)
        )
        # if QT_CONFIG(tooltip)
        self.cbx_thd.setToolTip(
            QCoreApplication.translate(
                "frm_tapping", "Seleccione la dimensi\u00f3n de la rosca", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.lbl_thd.setText(
            QCoreApplication.translate(
                "frm_tapping", "Dimensi\u00f3n de la rosca", None
            )
        )
        self.btn_help.setText("")
        # if QT_CONFIG(shortcut)
        self.btn_help.setShortcut(QCoreApplication.translate("frm_tapping", "F1", None))
