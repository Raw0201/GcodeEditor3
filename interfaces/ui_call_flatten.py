...
class Ui_frm_call_flatten(object):
    def setupUi(self, frm_call_flatten):
        if not frm_call_flatten.objectName():
            frm_call_flatten.setObjectName("frm_call_flatten")
        ...
        frm_call_flatten.setStyleSheet(
            "/* ---------------------------------------------------------------------------\n"
            "\n"
    ...
    def retranslateUi(self, frm_call_flatten):
        frm_call_flatten.setWindowTitle(
            QCoreApplication.translate("frm_call_flatten", "GCode Editor", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_sub.setToolTip(
            QCoreApplication.translate(
                "frm_call_flatten", "Digite el texto del comentario", None
            )
        )
        ...
        self.lbl_col_qty.setText(
            QCoreApplication.translate(
                "frm_call_flatten", "N\u00famero de subrutina", None
            )
        )
        self.lbl_col_space.setText(
            QCoreApplication.translate(
                "frm_call_flatten", "Profundidad a refrentar", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.btn_save.setToolTip(
            QCoreApplication.translate(
                "frm_call_flatten", "Agregar los datos al programa CNC", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.btn_save.setText(
            QCoreApplication.translate("frm_call_flatten", "Agregar", None)
        )
        # if QT_CONFIG(shortcut)
        self.btn_save.setShortcut(
            QCoreApplication.translate("frm_call_flatten", "Ctrl+S", None)
        )
        # endif // QT_CONFIG(shortcut)
        # if QT_CONFIG(tooltip)
        ...
        self.lbl_row_qty.setText(
            QCoreApplication.translate(
                "frm_call_flatten", "Profundidad por corte", None
            )
        )
        self.btn_help.setText("")
        # if QT_CONFIG(shortcut)
        self.btn_help.setShortcut(
            QCoreApplication.translate("frm_call_flatten", "F1", None)
        )
