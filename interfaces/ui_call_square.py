...
class Ui_frm_call_square(object):
    def setupUi(self, frm_call_square):
        if not frm_call_square.objectName():
            frm_call_square.setObjectName(u"frm_call_square")
        ...
        frm_call_square.setStyleSheet(u"/* ---------------------------------------------------------------------------\n"
"\n"
...
#endif // QT_CONFIG(statustip)
        self.btn_save.setText(QCoreApplication.translate("frm_call_square", u"Agregar", None))
#if QT_CONFIG(shortcut)
...
#endif // QT_CONFIG(statustip)
        self.tbx_unblk.setText(QCoreApplication.translate("frm_call_square", u"1", None))
...
#if QT_CONFIG(shortcut)
        self.btn_help.setShortcut(QCoreApplication.translate("frm_call_square", u"F1", None))
#endif // QT_CONFIG(shortcut)
    # retranslateUi
