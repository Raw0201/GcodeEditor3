...
class Ui_frm_call_square(object):
    def setupUi(self, frm_call_square):
        if not frm_call_square.objectName():
            frm_call_square.setObjectName("frm_call_square")
        frm_call_square.resize(210, 380)
        sizePolicy = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(frm_call_square.sizePolicy().hasHeightForWidth())
        frm_call_square.setSizePolicy(sizePolicy)
        frm_call_square.setMinimumSize(QSize(210, 380))
        frm_call_square.setMaximumSize(QSize(360, 380))
        icon = QIcon()
        icon.addFile(":/icons/gear.png", QSize(), QIcon.Normal, QIcon.Off)
        frm_call_square.setWindowIcon(icon)
        frm_call_square.setStyleSheet(
            "/* ---------------------------------------------------------------------------\n"
            "\n"
        ...
        self.centralwidget = QWidget(frm_call_square)
        ...
        self.tbx_unblk.setGeometry(QRect(13, 180, 170, 26))
        ...
        self.cbx_dir.setGeometry(QRect(13, 280, 170, 26))
        ...
        self.lbl_dir.setGeometry(QRect(15, 260, 141, 26))
        self.tbx_sub.raise_()
        self.lbl_sub.raise_()
        self.cbx_sec.raise_()
        self.lbl_sec.raise_()
        ...
        frm_call_square.setCentralWidget(self.centralwidget)
        ...
        self.lbl_dir.setBuddy(self.lbl_sec)
        # endif // QT_CONFIG(shortcut)
        QWidget.setTabOrder(self.tbx_sub, self.tbx_dpt)
        QWidget.setTabOrder(self.tbx_dpt, self.tbx_cut)
        QWidget.setTabOrder(self.tbx_cut, self.tbx_unblk)
        QWidget.setTabOrder(self.tbx_unblk, self.cbx_sec)
        QWidget.setTabOrder(self.cbx_sec, self.btn_save)
        QWidget.setTabOrder(self.btn_save, self.btn_help)

        self.retranslateUi(frm_call_square)

        QMetaObject.connectSlotsByName(frm_call_square)

    # setupUi

    def retranslateUi(self, frm_call_square):
        frm_call_square.setWindowTitle(
            QCoreApplication.translate("frm_call_square", "GCode Editor", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_sub.setToolTip(
            QCoreApplication.translate(
                "frm_call_square", "Indique el n\u00famero de subrutina", None
            )
        )
        ...
        self.lbl_sub.setText(
            QCoreApplication.translate(
                "frm_call_square", "N\u00famero de subrutina", None
            )
        )
        self.lbl_sec.setText(
            QCoreApplication.translate("frm_call_square", "Retorno a Z seguridad", None)
        )
        # if QT_CONFIG(tooltip)
        ...
        self.btn_save.setToolTip(
            QCoreApplication.translate(
                "frm_call_square", "Agregar los datos al programa CNC", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.btn_save.setText(
            QCoreApplication.translate("frm_call_square", "Agregar", None)
        )
        # if QT_CONFIG(shortcut)
        self.btn_save.setShortcut(
            QCoreApplication.translate("frm_call_square", "Ctrl+S", None)
        )
        # endif // QT_CONFIG(shortcut)
        # if QT_CONFIG(tooltip)
        self.tbx_dpt.setToolTip(
            QCoreApplication.translate(
                "frm_call_square",
                "Indique la profundidad a maquinar o la posici\u00f3n de inicio en el eje Z",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.lbl_dpt.setText(
            QCoreApplication.translate(
                "frm_call_square", "Profundidad / Posici\u00f3n Z", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.tbx_cut.setToolTip(
            QCoreApplication.translate(
                "frm_call_square", "Indique la profundidad por corte", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.lbl_cut.setText(
            QCoreApplication.translate("frm_call_square", "Profundidad por corte", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_unblk.setToolTip(
            QCoreApplication.translate(
                "frm_call_square", "Indique la cantidad de piezas desbloqueadas", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        # endif // QT_CONFIG(statustip)
        self.tbx_unblk.setText(QCoreApplication.translate("frm_call_square", "1", None))
        self.tbx_unblk.setPlaceholderText("")
        self.lbl_unblk.setText(
            QCoreApplication.translate("frm_call_square", "Piezas desbloqueadas", None)
        )
        # if QT_CONFIG(tooltip)
        self.cbx_dir.setToolTip(
            QCoreApplication.translate(
                "frm_call_square", "Seleccione la direcci\u00f3n de maquinado", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.lbl_dir.setText(
            QCoreApplication.translate(
                "frm_call_square", "Direcci\u00f3n de maquinado", None
            )
        )
        self.btn_help.setText("")
        # if QT_CONFIG(shortcut)
        self.btn_help.setShortcut(
            QCoreApplication.translate("frm_call_square", "F1", None)
        )
