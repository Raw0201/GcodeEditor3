...
################################################################################
## Form generated from reading UI file 'header_subVoHXsO.ui'
##
...
class Ui_frm_header_sub(object):
    def setupUi(self, frm_header_sub):
        if not frm_header_sub.objectName():
            frm_header_sub.setObjectName("frm_header_sub")
        frm_header_sub.resize(210, 330)
        ...
        frm_header_sub.setMinimumSize(QSize(210, 330))
        frm_header_sub.setMaximumSize(QSize(210, 330))
        icon = QIcon()
        icon.addFile(":/icons/gear.png", QSize(), QIcon.Normal, QIcon.Off)
        frm_header_sub.setWindowIcon(icon)
        frm_header_sub.setStyleSheet(
            "/* ---------------------------------------------------------------------------\n"
            "\n"
        ...
        self.lbl_mnp.setObjectName("lbl_mnp")
        ...
        self.lbl_mch.setGeometry(QRect(15, 160, 100, 26))
        ...
        self.lbl_lgt.setGeometry(QRect(15, 210, 141, 26))
        ...
        QWidget.setTabOrder(self.cbx_mch, self.tbx_lgt)
        QWidget.setTabOrder(self.tbx_lgt, self.btn_save)
    ...
    def retranslateUi(self, frm_header_sub):
        frm_header_sub.setWindowTitle(
            QCoreApplication.translate("frm_header_sub", "GCode Editor", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_pgr.setToolTip(
            QCoreApplication.translate(
                "frm_header_sub", "Digite el nombre de la pieza", None
            )
        )
        ...
        self.lbl_pgr.setText(
            QCoreApplication.translate(
                "frm_header_sub", "N\u00famero de subrutina", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.tbx_mnp.setToolTip(
            QCoreApplication.translate(
                "frm_header_sub",
        ...
        # endif // QT_CONFIG(statustip)
        self.lbl_mnp.setText(
            QCoreApplication.translate("frm_header_sub", "Programa principal", None)
        )
        # if QT_CONFIG(tooltip)
        self.btn_save.setToolTip(
            QCoreApplication.translate(
                "frm_header_sub", "Agregar los datos al programa CNC", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.btn_save.setText(
            QCoreApplication.translate("frm_header_sub", "Agregar", None)
        )
        # if QT_CONFIG(shortcut)
        self.btn_save.setShortcut(
            QCoreApplication.translate("frm_header_sub", "Ctrl+S", None)
        )
        # endif // QT_CONFIG(shortcut)
        # if QT_CONFIG(tooltip)
        self.tbx_dsc.setToolTip(
            QCoreApplication.translate(
                "frm_header_sub", "Digite una descripci\u00f3n para la subrutina", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.lbl_dsc.setText(
            QCoreApplication.translate("frm_header_sub", "Descripci\u00f3n", None)
        )
        self.lbl_mch.setText(
            QCoreApplication.translate("frm_header_sub", "Tipo de m\u00e1quina", None)
        )
        # if QT_CONFIG(tooltip)
        self.cbx_mch.setToolTip(
            QCoreApplication.translate(
                "frm_header_sub", "Seleccione el tipo de m\u00e1quina CNC", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.lbl_lgt.setText(
            QCoreApplication.translate(
                "frm_header_sub", "Longitud de la subrutina", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.tbx_lgt.setToolTip(
            QCoreApplication.translate(
                "frm_header_sub",
                "Digite la longitud total de la subrutina (Torno suizo)",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.btn_help.setShortcut(
            QCoreApplication.translate("frm_header_sub", "F1", None)
        )
