...
################################################################################
## Form generated from reading UI file 'face_millgNBKmz.ui'
##
...
class Ui_frm_face_mill(object):
    def setupUi(self, frm_face_mill):
        if not frm_face_mill.objectName():
            frm_face_mill.setObjectName("frm_face_mill")
        ...
        self.tbx_wdt.setObjectName("tbx_wdt")
        ...
        self.lbl_wdt.setObjectName("lbl_wdt")
        ...
        self.tbx_mat.setObjectName("tbx_mat")
    ...
    def retranslateUi(self, frm_face_mill):
        frm_face_mill.setWindowTitle(
            QCoreApplication.translate("frm_face_mill", "GCode Editor", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_wdt.setToolTip(
            QCoreApplication.translate(
                "frm_face_mill",
                "Digite la dimensi\u00f3n total del espesor de las caras",
                None,
            )
        )
        ...
        self.lbl_wdt.setText(
            QCoreApplication.translate("frm_face_mill", "Espesor de las caras", None)
        )
        # if QT_CONFIG(tooltip)
        self.btn_save.setToolTip(
            QCoreApplication.translate(
                "frm_face_mill", "Agregar los datos al programa CNC", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.btn_save.setText(
            QCoreApplication.translate("frm_face_mill", "Agregar", None)
        )
        # if QT_CONFIG(shortcut)
        self.btn_save.setShortcut(
            QCoreApplication.translate("frm_face_mill", "Ctrl+S", None)
        )
        # endif // QT_CONFIG(shortcut)
        self.lbl_dyr.setText(
            QCoreApplication.translate(
                "frm_face_mill", "Direcci\u00f3n de los cortes", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.cbx_dyr.setToolTip(
            QCoreApplication.translate(
                "frm_face_mill", "Seleccione la direcci\u00f3n de los cortes", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        self.tbx_mat.setToolTip(
            QCoreApplication.translate(
                "frm_face_mill",
                "Digite la dimensi\u00f3n del di\u00e1metro de la punta sin maquinar",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.lbl_mat.setText(
            QCoreApplication.translate(
                "frm_face_mill", "Di\u00e1metro de la punta", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.tbx_fed.setToolTip(
            QCoreApplication.translate(
                "frm_face_mill", "Digite la velocidad de avance de corte", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.lbl_fed.setText(
            QCoreApplication.translate("frm_face_mill", "Avance de corte", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_lgt.setToolTip(
            QCoreApplication.translate(
                "frm_face_mill",
                "Digite la dimensi\u00f3n de la longitud de la cara",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.lbl_lgt.setText(
            QCoreApplication.translate("frm_face_mill", "Longitud de la cara", None)
        )
        # if QT_CONFIG(tooltip)
        self.cbx_pos.setToolTip(
            QCoreApplication.translate(
                "frm_face_mill", "Seleccione la posici\u00f3n de la cara plana", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.lbl_pos.setText(
            QCoreApplication.translate(
                "frm_face_mill", "Posici\u00f3n de la cara", None
            )
        )
        self.lbl_cut.setText(
            QCoreApplication.translate("frm_face_mill", "Profundidad por corte", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_cut.setToolTip(
            QCoreApplication.translate(
                "frm_face_mill",
                "Digite la dimensi\u00f3n de la profundidad por corte",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.tbx_tcm.setToolTip(
            QCoreApplication.translate(
                "frm_face_mill",
                "Digite la dimensi\u00f3n de la compensaci\u00f3n en el eje transversal (ancho)",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        # endif // QT_CONFIG(statustip)
        self.tbx_tcm.setText(QCoreApplication.translate("frm_face_mill", "0.0", None))
        self.tbx_tcm.setPlaceholderText("")
        self.lbl_tcm.setText(
            QCoreApplication.translate(
                "frm_face_mill", "Compensaci\u00f3n transversal", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.tbx_lcm.setToolTip(
            QCoreApplication.translate(
                "frm_face_mill",
                "Digite la dimensi\u00f3n de la compensaci\u00f3n en el eje longitudinal (largo)",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        # endif // QT_CONFIG(statustip)
        self.tbx_lcm.setText(QCoreApplication.translate("frm_face_mill", "0.0", None))
        self.tbx_lcm.setPlaceholderText("")
        self.lbl_lcm.setText(
            QCoreApplication.translate(
                "frm_face_mill", "Compensaci\u00f3n longitudinal", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.tbx_ang.setToolTip(
            QCoreApplication.translate(
                "frm_face_mill",
                "Digite la dimensi\u00f3n del \u00e1ngulo de la cara",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.lbl_ang.setText(
            QCoreApplication.translate("frm_face_mill", "\u00c1ngulo de la cara", None)
        )
        self.btn_help.setText("")
        # if QT_CONFIG(shortcut)
        self.btn_help.setShortcut(
            QCoreApplication.translate("frm_face_mill", "F1", None)
        )
