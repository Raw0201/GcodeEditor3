...
class Ui_frm_comment(object):
    def setupUi(self, frm_comment):
        if not frm_comment.objectName():
            frm_comment.setObjectName("frm_comment")
    ...
    def retranslateUi(self, frm_comment):
        frm_comment.setWindowTitle(
            QCoreApplication.translate("frm_comment", "GCode Editor", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_com.setToolTip(
            QCoreApplication.translate(
                "frm_comment", "Digite el texto del comentario", None
            )
        )
        ...
        self.lbl_com.setText(
            QCoreApplication.translate("frm_comment", "Comentario", None)
        )
        self.lbl_sde.setText(
            QCoreApplication.translate("frm_comment", "Husillo de trabajo", None)
        )
        # if QT_CONFIG(tooltip)
        self.cbx_sde.setToolTip(
            QCoreApplication.translate(
                "frm_comment", "Seleccione el husillo de trabajo a utilizar", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        self.btn_save.setToolTip(
            QCoreApplication.translate(
                "frm_comment", "Agregar los datos al programa CNC", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.btn_save.setText(
            QCoreApplication.translate("frm_comment", "Agregar", None)
        )
        # if QT_CONFIG(shortcut)
        self.btn_save.setShortcut(
            QCoreApplication.translate("frm_comment", "Ctrl+S", None)
        )
        # endif // QT_CONFIG(shortcut)
        self.btn_help.setText("")
        # if QT_CONFIG(shortcut)
        self.btn_help.setShortcut(QCoreApplication.translate("frm_comment", "F1", None))
