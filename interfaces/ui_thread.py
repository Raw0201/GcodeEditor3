...
################################################################################
## Form generated from reading UI file 'threadKePCdV.ui'
##
...
class Ui_frm_thread(object):
    def setupUi(self, frm_thread):
        if not frm_thread.objectName():
            frm_thread.setObjectName("frm_thread")
        ...
        self.tbx_znd.setObjectName("tbx_znd")
        ...
        self.cbx_rgh.setObjectName("cbx_rgh")
        ...
        self.lbl_rgh.setObjectName("lbl_rgh")
    ...
    def retranslateUi(self, frm_thread):
        frm_thread.setWindowTitle(
            QCoreApplication.translate("frm_thread", "GCode Editor", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_zin.setToolTip(
            QCoreApplication.translate(
                "frm_thread",
                "Digite la posici\u00f3n inicial de la rosca en el eje Z",
                None,
            )
        )
        ...
        self.lbl_zin.setText(
            QCoreApplication.translate("frm_thread", "Posici\u00f3n inicial Z", None)
        )
        # if QT_CONFIG(tooltip)
        self.btn_save.setToolTip(
            QCoreApplication.translate(
                "frm_thread", "Agregar los datos al programa CNC", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        # endif // QT_CONFIG(statustip)
        self.btn_save.setText(QCoreApplication.translate("frm_thread", "Agregar", None))
        # if QT_CONFIG(shortcut)
        self.btn_save.setShortcut(
            QCoreApplication.translate("frm_thread", "Ctrl+S", None)
        )
        # endif // QT_CONFIG(shortcut)
        self.lbl_thd.setText(
            QCoreApplication.translate("frm_thread", "Dimensi\u00f3n de la rosca", None)
        )
        self.lbl_znd.setText(
            QCoreApplication.translate("frm_thread", "Posici\u00f3n final Z", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_znd.setToolTip(
            QCoreApplication.translate(
                "frm_thread",
                "Digite la posici\u00f3n final de la rosca en el eje Z",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.cbx_thd.setToolTip(
            QCoreApplication.translate(
                "frm_thread", "Seleccione la dimensi\u00f3n de la rosca", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        self.cbx_pos.setToolTip(
            QCoreApplication.translate(
                "frm_thread", "Seleccione la posici\u00f3n de la herramienta", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.lbl_pos.setText(
            QCoreApplication.translate(
                "frm_thread", "Posici\u00f3n de herramienta", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.cbx_typ.setToolTip(
            QCoreApplication.translate(
                "frm_thread",
                "Seleccione si la rosca es de tipo externa o interna",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.lbl_typ.setText(
            QCoreApplication.translate("frm_thread", "Tipo de rosca", None)
        )
        # if QT_CONFIG(tooltip)
        self.cbx_rgh.setToolTip(
            QCoreApplication.translate(
                "frm_thread",
                "Seleccione si se requiere desahogo de la rosca (corte inicial)",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.lbl_rgh.setText(
            QCoreApplication.translate("frm_thread", "Desahogo de rosca", None)
        )
        self.btn_help.setText("")
        # if QT_CONFIG(shortcut)
        self.btn_help.setShortcut(QCoreApplication.translate("frm_thread", "F1", None))
