...
class Ui_frm_rough_turn_cycle(object):
    def setupUi(self, frm_rough_turn_cycle):
        if not frm_rough_turn_cycle.objectName():
            frm_rough_turn_cycle.setObjectName("frm_rough_turn_cycle")
        frm_rough_turn_cycle.resize(210, 280)
        sizePolicy = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            frm_rough_turn_cycle.sizePolicy().hasHeightForWidth()
        )
        ...
        frm_rough_turn_cycle.setStyleSheet(
            "/* ---------------------------------------------------------------------------\n"
            "\n"
        ...
        self.tbx_ovr.setObjectName("tbx_ovr")
        ...
        self.lbl_ovr.setObjectName("lbl_ovr")
    ...
    def retranslateUi(self, frm_rough_turn_cycle):
        frm_rough_turn_cycle.setWindowTitle(
            QCoreApplication.translate("frm_rough_turn_cycle", "GCode Editor", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_cut.setToolTip(
            QCoreApplication.translate(
                "frm_rough_turn_cycle",
                "Digite la profundidad de corte por pasada",
                None,
            )
        )
        ...
        self.lbl_cut.setText(
            QCoreApplication.translate(
                "frm_rough_turn_cycle", "Profundidad por corte", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.btn_save.setToolTip(
            QCoreApplication.translate(
                "frm_rough_turn_cycle", "Agregar los datos al programa CNC", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.btn_save.setText(
            QCoreApplication.translate("frm_rough_turn_cycle", "Agregar", None)
        )
        # if QT_CONFIG(shortcut)
        self.btn_save.setShortcut(
            QCoreApplication.translate("frm_rough_turn_cycle", "Ctrl+S", None)
        )
        # endif // QT_CONFIG(shortcut)
        # if QT_CONFIG(tooltip)
        self.tbx_ovr.setToolTip(
            QCoreApplication.translate(
                "frm_rough_turn_cycle",
                "Digite la dimensi\u00f3n del sobrematerial para el acabado",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        # endif // QT_CONFIG(statustip)
        self.tbx_ovr.setText(
            QCoreApplication.translate("frm_rough_turn_cycle", "0.005", None)
        )
        self.tbx_ovr.setPlaceholderText("")
        self.lbl_ovr.setText(
            QCoreApplication.translate(
                "frm_rough_turn_cycle", "Material para acabado", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.tbx_fed.setToolTip(
            QCoreApplication.translate(
                "frm_rough_turn_cycle", "Digite la velocidad de avance de corte", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.tbx_fed.setText(
            QCoreApplication.translate("frm_rough_turn_cycle", "0.01", None)
        )
        self.tbx_fed.setPlaceholderText("")
        self.lbl_fed.setText(
            QCoreApplication.translate("frm_rough_turn_cycle", "Avance de corte", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_seq.setToolTip(
            QCoreApplication.translate(
                "frm_rough_turn_cycle",
                "Digite el n\u00famero de secuencia inicial del ciclo",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.lbl_seq.setText(
            QCoreApplication.translate(
                "frm_rough_turn_cycle", "Secuencia inicial", None
            )
        )
        self.btn_help.setText("")
        # if QT_CONFIG(shortcut)
        self.btn_help.setShortcut(
            QCoreApplication.translate("frm_rough_turn_cycle", "F1", None)
        )
