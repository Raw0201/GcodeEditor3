...
################################################################################
## Form generated from reading UI file 'lineal_turnFLzSNi.ui'
##
...
class Ui_frm_lineal_turn(object):
    def setupUi(self, frm_lineal_turn):
        if not frm_lineal_turn.objectName():
            frm_lineal_turn.setObjectName("frm_lineal_turn")
        ...
        self.tbx_seq.setObjectName("tbx_seq")
        ...
        self.lbl_seq.setObjectName("lbl_seq")
    ...
    def retranslateUi(self, frm_lineal_turn):
        frm_lineal_turn.setWindowTitle(
            QCoreApplication.translate("frm_lineal_turn", "GCode Editor", None)
        )
        ...
        self.lbl_xin.setText(
            QCoreApplication.translate("frm_lineal_turn", "Movimiento eje X", None)
        )
        # if QT_CONFIG(tooltip)
        self.btn_save.setToolTip(
            QCoreApplication.translate(
                "frm_lineal_turn", "Agregar los datos al programa CNC", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.btn_save.setText(
            QCoreApplication.translate("frm_lineal_turn", "Agregar", None)
        )
        # if QT_CONFIG(shortcut)
        self.btn_save.setShortcut(
            QCoreApplication.translate("frm_lineal_turn", "Ctrl+S", None)
        )
        # endif // QT_CONFIG(shortcut)
        self.lbl_mov.setText(
            QCoreApplication.translate("frm_lineal_turn", "Tipo de movimiento", None)
        )
        # if QT_CONFIG(tooltip)
        self.cbx_mov.setToolTip(
            QCoreApplication.translate(
                "frm_lineal_turn", "Seleccione el tipo de movimiento a ejecutar", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        self.cbx_sde.setToolTip(
            QCoreApplication.translate(
                "frm_lineal_turn", "Seleccione el husillo de trabajo a utilizar", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.lbl_sde.setText(
            QCoreApplication.translate("frm_lineal_turn", "Husillo de trabajo", None)
        )
        # if QT_CONFIG(tooltip)
        ...
        self.lbl_zin.setText(
            QCoreApplication.translate("frm_lineal_turn", "Movimiento eje Z", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_fed.setToolTip(
            QCoreApplication.translate(
                "frm_lineal_turn", "Digite la velocidad de avance de corte", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.lbl_fed.setText(
            QCoreApplication.translate("frm_lineal_turn", "Avance de corte", None)
        )
        # if QT_CONFIG(tooltip)
        self.btn_switch.setToolTip(
            QCoreApplication.translate(
                "frm_lineal_turn", "Cambia a la funci\u00f3n indicada", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.btn_switch.setText(
            QCoreApplication.translate(
                "frm_lineal_turn", "Cambiar a Torneado radial", None
            )
        )
        # if QT_CONFIG(shortcut)
        self.btn_switch.setShortcut(
            QCoreApplication.translate("frm_lineal_turn", "Ctrl+Q", None)
        )
        # endif // QT_CONFIG(shortcut)
        # if QT_CONFIG(tooltip)
        self.tbx_seq.setToolTip(
            QCoreApplication.translate(
                "frm_lineal_turn", "Digite el n\u00famero de l\u00ednea", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        # endif // QT_CONFIG(statustip)
        self.tbx_seq.setText(QCoreApplication.translate("frm_lineal_turn", "0", None))
        self.tbx_seq.setPlaceholderText("")
        self.lbl_seq.setText(
            QCoreApplication.translate(
                "frm_lineal_turn", "N\u00famero de secuencia", None
            )
        )
        self.btn_help.setText("")
        # if QT_CONFIG(shortcut)
        self.btn_help.setShortcut(
            QCoreApplication.translate("frm_lineal_turn", "F1", None)
        )
