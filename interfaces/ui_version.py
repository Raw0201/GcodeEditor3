...
"}")
        ...
        self.lbl_picture.setPixmap(QPixmap(u":/icons/gear.png"))
        self.lbl_picture.setScaledContents(True)
        self.lbl_years = QLabel(self.centralwidget)
        self.lbl_years.setObjectName(u"lbl_years")
    ...
    def retranslateUi(self, frm_version):
        ...
        self.lbl_title.setText(QCoreApplication.translate("frm_version", u"GCodeEditor3 by Rau", None))
        self.lbl_picture.setText("")
        self.lbl_years.setText(QCoreApplication.translate("frm_version", u"2023", None))
    # retranslateUi
