...
################################################################################
## Form generated from reading UI file 'flat_milllbACvl.ui'
##
...
class Ui_frm_flat_mill(object):
    def setupUi(self, frm_flat_mill):
        if not frm_flat_mill.objectName():
            frm_flat_mill.setObjectName("frm_flat_mill")
    ...
    def retranslateUi(self, frm_flat_mill):
        frm_flat_mill.setWindowTitle(
            QCoreApplication.translate("frm_flat_mill", "GCode Editor", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_wdt.setToolTip(
            QCoreApplication.translate(
                "frm_flat_mill",
                "Digite la dimensi\u00f3n total del espesor de la paleta",
                None,
            )
        )
        ...
        self.lbl_wdt.setText(
            QCoreApplication.translate("frm_flat_mill", "Espesor de la paleta", None)
        )
        # if QT_CONFIG(tooltip)
        self.btn_save.setToolTip(
            QCoreApplication.translate(
                "frm_flat_mill", "Agregar los datos al programa CNC", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.btn_save.setText(
            QCoreApplication.translate("frm_flat_mill", "Agregar", None)
        )
        # if QT_CONFIG(shortcut)
        self.btn_save.setShortcut(
            QCoreApplication.translate("frm_flat_mill", "Ctrl+S", None)
        )
        # endif // QT_CONFIG(shortcut)
        self.lbl_dyr.setText(
            QCoreApplication.translate(
                "frm_flat_mill", "Direcci\u00f3n de los cortes", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.cbx_dyr.setToolTip(
            QCoreApplication.translate(
                "frm_flat_mill", "Seleccione la direcci\u00f3n de los cortes", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        ...
        self.lbl_mat.setText(
            QCoreApplication.translate(
                "frm_flat_mill", "Di\u00e1metro de la punta", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.tbx_fed.setToolTip(
            QCoreApplication.translate(
                "frm_flat_mill", "Digite la velocidad de avance de corte", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.lbl_fed.setText(
            QCoreApplication.translate("frm_flat_mill", "Avance de corte", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_lgt.setToolTip(
            QCoreApplication.translate(
                "frm_flat_mill",
                "Digite la dimensi\u00f3n de la longitud de la paleta",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.lbl_lgt.setText(
            QCoreApplication.translate(
                "frm_flat_mill", "Longitud de la cara plana", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.cbx_pos.setToolTip(
            QCoreApplication.translate(
                "frm_flat_mill", "Seleccione la posici\u00f3n de la cara plana", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.lbl_pos.setText(
            QCoreApplication.translate(
                "frm_flat_mill", "Posici\u00f3n de la cara plana", None
            )
        )
        self.lbl_cut.setText(
            QCoreApplication.translate("frm_flat_mill", "Profundidad por corte", None)
        )
        # if QT_CONFIG(tooltip)
        ...
        # endif // QT_CONFIG(statustip)
        self.tbx_tcm.setText(QCoreApplication.translate("frm_flat_mill", "0.0", None))
        self.tbx_tcm.setPlaceholderText("")
        self.lbl_tcm.setText(
            QCoreApplication.translate(
                "frm_flat_mill", "Compensaci\u00f3n transversal", None
            )
        )
        # if QT_CONFIG(tooltip)
        ...
        # endif // QT_CONFIG(statustip)
        self.tbx_lcm.setText(QCoreApplication.translate("frm_flat_mill", "0.0", None))
        self.tbx_lcm.setPlaceholderText("")
        self.lbl_lcm.setText(
            QCoreApplication.translate(
                "frm_flat_mill", "Compensaci\u00f3n longitudinal", None
            )
        )
        self.btn_help.setText("")
        # if QT_CONFIG(shortcut)
        self.btn_help.setShortcut(
            QCoreApplication.translate("frm_flat_mill", "F1", None)
        )
