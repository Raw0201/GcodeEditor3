...
################################################################################
## Form generated from reading UI file 'radial_millxvFUfI.ui'
##
...
class Ui_frm_radial_mill(object):
    def setupUi(self, frm_radial_mill):
        if not frm_radial_mill.objectName():
            frm_radial_mill.setObjectName("frm_radial_mill")
        ...
        self.lbl_mov.setObjectName("lbl_mov")
        self.lbl_mov.setEnabled(True)
        self.lbl_mov.setGeometry(QRect(15, 360, 90, 26))
        self.cbx_mov = QComboBox(self.frame)
        self.cbx_mov.setObjectName("cbx_mov")
        self.cbx_mov.setGeometry(QRect(10, 380, 170, 26))
        ...
        self.tbx_xcn.setObjectName("tbx_xcn")
        ...
        self.lbl_xcn.setObjectName("lbl_xcn")
        ...
        self.tbx_ycn.setObjectName("tbx_ycn")
        ...
        self.lbl_zcn.setObjectName("lbl_zcn")
        ...
        QWidget.setTabOrder(self.tbx_zcn, self.cbx_mov)
    ...
    def retranslateUi(self, frm_radial_mill):
        frm_radial_mill.setWindowTitle(
            QCoreApplication.translate("frm_radial_mill", "GCode Editor", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_xin.setToolTip(
            QCoreApplication.translate(
                "frm_radial_mill",
                "Digite la dimensi\u00f3n del movimiento en el eje X",
                None,
            )
        )
        ...
        self.lbl_xin.setText(
            QCoreApplication.translate("frm_radial_mill", "Movimiento eje X", None)
        )
        # if QT_CONFIG(tooltip)
        self.btn_save.setToolTip(
            QCoreApplication.translate(
                "frm_radial_mill", "Agregar los datos al programa CNC", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.btn_save.setText(
            QCoreApplication.translate("frm_radial_mill", "Agregar", None)
        )
        # if QT_CONFIG(shortcut)
        self.btn_save.setShortcut(
            QCoreApplication.translate("frm_radial_mill", "Ctrl+S", None)
        )
        # endif // QT_CONFIG(shortcut)
        self.lbl_mov.setText(
            QCoreApplication.translate("frm_radial_mill", "Sentido de giro", None)
        )
        # if QT_CONFIG(tooltip)
        self.cbx_mov.setToolTip(
            QCoreApplication.translate(
                "frm_radial_mill", "Seleccione el tipo de movimiento a ejecutar", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        self.tbx_zin.setToolTip(
            QCoreApplication.translate(
                "frm_radial_mill",
                "Digite la dimensi\u00f3n del movimiento en el eje Z",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.lbl_zin.setText(
            QCoreApplication.translate("frm_radial_mill", "Movimiento eje Z", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_fed.setToolTip(
            QCoreApplication.translate(
                "frm_radial_mill", "Digite la velocidad de avance de corte", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.lbl_fed.setText(
            QCoreApplication.translate("frm_radial_mill", "Avance de corte", None)
        )
        # if QT_CONFIG(tooltip)
        self.btn_switch.setToolTip(
            QCoreApplication.translate(
                "frm_radial_mill", "Cambia a la funci\u00f3n indicada", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.btn_switch.setText(
            QCoreApplication.translate(
                "frm_radial_mill", "Cambiar a Fresado lineal", None
            )
        )
        # if QT_CONFIG(shortcut)
        self.btn_switch.setShortcut(
            QCoreApplication.translate("frm_radial_mill", "Ctrl+Q", None)
        )
        # endif // QT_CONFIG(shortcut)
        # if QT_CONFIG(tooltip)
        self.tbx_xcn.setToolTip(
            QCoreApplication.translate(
                "frm_radial_mill",
                "Digite la dimensi\u00f3n del radio o el punto centro en el eje X",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.lbl_xcn.setText(
            QCoreApplication.translate(
                "frm_radial_mill", "Radio / Punto centro X", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.tbx_yin.setToolTip(
            QCoreApplication.translate(
                "frm_radial_mill",
                "Digite la dimensi\u00f3n del movimiento en el eje Y",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.lbl_yin.setText(
            QCoreApplication.translate("frm_radial_mill", "Movimiento eje Y", None)
        )
        # if QT_CONFIG(tooltip)
        self.cbx_sys.setToolTip(
            QCoreApplication.translate(
                "frm_radial_mill",
                "Seleccione el sistema de coordenadas a utilizar",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.lbl_sys.setText(
            QCoreApplication.translate(
                "frm_radial_mill", "Sistema de coordenadas", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.tbx_ycn.setToolTip(
            QCoreApplication.translate(
                "frm_radial_mill",
                "Digite la dimensi\u00f3n del punto centro del radio en el eje Y",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.lbl_ycn.setText(
            QCoreApplication.translate("frm_radial_mill", "Punto centro Y", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_zcn.setToolTip(
            QCoreApplication.translate(
                "frm_radial_mill",
                "Digite la dimensi\u00f3n del punto centro del radio en el eje Z",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.lbl_zcn.setText(
            QCoreApplication.translate("frm_radial_mill", "Punto centro Z", None)
        )
        self.btn_help.setText("")
        # if QT_CONFIG(shortcut)
        self.btn_help.setShortcut(
            QCoreApplication.translate("frm_radial_mill", "F1", None)
        )
