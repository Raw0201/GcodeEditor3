...
#endif // QT_CONFIG(shortcut)
        self.lbl_mov.setText(QCoreApplication.translate("frm_radial_mill", u"Sentido de giro", None))
#if QT_CONFIG(tooltip)
        self.cbx_mov.setToolTip(QCoreApplication.translate("frm_radial_mill", u"Seleccione el tipo de movimiento a ejecutar", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
