...
class Ui_frm_header(object):
    def setupUi(self, frm_header):
        if not frm_header.objectName():
            frm_header.setObjectName("frm_header")
        ...
        self.tbx_prt.setObjectName("tbx_prt")
        ...
        self.tbx_pgr.setObjectName("tbx_pgr")
        ...
        self.tbx_dsc.setObjectName("tbx_dsc")
        ...
        self.cbx_wrk.setObjectName("cbx_wrk")
        ...
        self.tbx_chk.setObjectName("tbx_chk")
        ...
        self.lbl_cof.setObjectName("lbl_cof")
    ...
    def retranslateUi(self, frm_header):
        frm_header.setWindowTitle(
            QCoreApplication.translate("frm_header", "GCode Editor", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_prt.setToolTip(
            QCoreApplication.translate(
                "frm_header", "Digite el nombre de la pieza", None
            )
        )
        ...
        self.lbl_prt.setText(
            QCoreApplication.translate("frm_header", "Nombre de la pieza", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_pgr.setToolTip(
            QCoreApplication.translate(
                "frm_header",
                "Indique el n\u00famero de programa CNC seg\u00fan la lista de tapes",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        # endif // QT_CONFIG(statustip)
        self.lbl_prg.setText(
            QCoreApplication.translate("frm_header", "N\u00famero de programa", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_dsc.setToolTip(
            QCoreApplication.translate(
                "frm_header", "Digite la descripci\u00f3n del programa CNC", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.lbl_dsc.setText(
            QCoreApplication.translate(
                "frm_header", "Descripci\u00f3n del programa", None
            )
        )
        self.lbl_mch.setText(
            QCoreApplication.translate("frm_header", "Tipo de m\u00e1quina", None)
        )
        # if QT_CONFIG(tooltip)
        self.cbx_mch.setToolTip(
            QCoreApplication.translate(
                "frm_header", "Seleccione el tipo de m\u00e1quina CNC", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        self.btn_save.setToolTip(
            QCoreApplication.translate(
                "frm_header", "Agregar los datos al programa CNC", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        # endif // QT_CONFIG(statustip)
        self.btn_save.setText(QCoreApplication.translate("frm_header", "Agregar", None))
        # if QT_CONFIG(shortcut)
        self.btn_save.setShortcut(
            QCoreApplication.translate("frm_header", "Ctrl+S", None)
        )
        # endif // QT_CONFIG(shortcut)
        # if QT_CONFIG(tooltip)
        self.cbx_wrk.setToolTip(
            QCoreApplication.translate(
                "frm_header",
                "Seleccione las coordenadas prefijadas de trabajo a utilizar (Mazak)",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.lbl_chk.setText(
            QCoreApplication.translate("frm_header", "Longitud de sujeci\u00f3n", None)
        )
        self.lbl_lgt.setText(
            QCoreApplication.translate("frm_header", "Longitud de la pieza", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_chk.setToolTip(
            QCoreApplication.translate(
                "frm_header",
                "Digite la longitud de la sujeci\u00f3n del husillo posterior (Torno suizo)",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.tbx_lgt.setToolTip(
            QCoreApplication.translate(
                "frm_header", "Digite la longitud total de la pieza (Torno suizo)", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        # endif // QT_CONFIG(statustip)
        self.lbl_cof.setText(
            QCoreApplication.translate("frm_header", "Cuchilla tronzar", None)
        )
        self.lbl_dia.setText(
            QCoreApplication.translate("frm_header", "Di\u00e1metro del material", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_dia.setToolTip(
            QCoreApplication.translate(
                "frm_header", "Digite el di\u00e1metro del material (Torno suizo)", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.lbl_wrk.setText(
            QCoreApplication.translate("frm_header", "Coordenadas de trabajo", None)
        )
        # if QT_CONFIG(tooltip)
        self.cbx_cof.setToolTip(
            QCoreApplication.translate(
                "frm_header",
                "Seleccione el tipo de cuchilla de tronzar a utilizar (Torno suizo)",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(shortcut)
        self.btn_help.setShortcut(QCoreApplication.translate("frm_header", "F1", None))
