...
################################################################################
## Form generated from reading UI file 'center_drillMohPZB.ui'
##
...
class Ui_frm_center_drill(object):
    def setupUi(self, frm_center_drill):
        if not frm_center_drill.objectName():
            frm_center_drill.setObjectName("frm_center_drill")
        ...
        frm_center_drill.setStyleSheet(
            "/* ---------------------------------------------------------------------------\n"
            "\n"
    ...
    def retranslateUi(self, frm_center_drill):
        frm_center_drill.setWindowTitle(
            QCoreApplication.translate("frm_center_drill", "GCode Editor", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_dpt.setToolTip(
            QCoreApplication.translate(
                "frm_center_drill", "Digite la profundidad del agujero de centro", None
            )
        )
        ...
        self.tbx_dpt.setText(
            QCoreApplication.translate("frm_center_drill", ".05", None)
        )
        self.tbx_dpt.setPlaceholderText("")
        self.lbl_dpt.setText(
            QCoreApplication.translate(
                "frm_center_drill", "Profundidad del agujero", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.tbx_dwl.setToolTip(
            QCoreApplication.translate(
                "frm_center_drill", "Digite el tiempo de espera en segundos", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.tbx_dwl.setText(
            QCoreApplication.translate("frm_center_drill", "0.0", None)
        )
        self.tbx_dwl.setPlaceholderText("")
        self.lbl_dwl.setText(
            QCoreApplication.translate("frm_center_drill", "Tiempo de espera", None)
        )
        # if QT_CONFIG(tooltip)
        self.btn_save.setToolTip(
            QCoreApplication.translate(
                "frm_center_drill", "Agregar los datos al programa CNC", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.btn_save.setText(
            QCoreApplication.translate("frm_center_drill", "Agregar", None)
        )
        # if QT_CONFIG(shortcut)
        self.btn_save.setShortcut(
            QCoreApplication.translate("frm_center_drill", "Ctrl+S", None)
        )
        # endif // QT_CONFIG(shortcut)
        self.lbl_fed.setText(
            QCoreApplication.translate("frm_center_drill", "Avance de corte", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_fed.setToolTip(
            QCoreApplication.translate(
                "frm_center_drill", "Digite la velocidad de avance de corte", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.tbx_fed.setText(
            QCoreApplication.translate("frm_center_drill", ".005", None)
        )
        self.tbx_fed.setPlaceholderText("")
        # if QT_CONFIG(tooltip)
        self.cbx_sde.setToolTip(
            QCoreApplication.translate(
                "frm_center_drill", "Seleccione el husillo de trabajo a utilizar", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.lbl_sde.setText(
            QCoreApplication.translate("frm_center_drill", "Husillo de trabajo", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_xin.setToolTip(
            QCoreApplication.translate(
                "frm_center_drill",
                "Digite la posici\u00f3n de inicio en el eje X",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.lbl_xin.setText(
            QCoreApplication.translate(
                "frm_center_drill", "Posici\u00f3n inicio X", None
            )
        )
        self.lbl_yin.setText(
            QCoreApplication.translate(
                "frm_center_drill", "Posici\u00f3n inicio Y", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.tbx_yin.setToolTip(
            QCoreApplication.translate(
                "frm_center_drill",
                "Digite la posici\u00f3n de inicio en el eje Y",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.lbl_zin.setText(
            QCoreApplication.translate(
                "frm_center_drill", "Posici\u00f3n inicio Z", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.tbx_zin.setToolTip(
            QCoreApplication.translate(
                "frm_center_drill",
                "Digite la posici\u00f3n de inicio en el eje Z",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.lbl_sys.setText(
            QCoreApplication.translate(
                "frm_center_drill", "Sistema de coordenadas", None
            )
        )
        self.lbl_znd.setText(
            QCoreApplication.translate(
                "frm_center_drill", "Posici\u00f3n de salida", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.cbx_znd.setToolTip(
            QCoreApplication.translate(
                "frm_center_drill", "Seleccione el punto de salida del perforado", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        self.tbx_rtr.setToolTip(
            QCoreApplication.translate(
                "frm_center_drill", "Digite la distancia de retracci\u00f3n", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.lbl_rtr.setText(
            QCoreApplication.translate(
                "frm_center_drill", "Punto de retracci\u00f3n", None
            )
        )
        self.btn_help.setText("")
        # if QT_CONFIG(shortcut)
        self.btn_help.setShortcut(
            QCoreApplication.translate("frm_center_drill", "F1", None)
        )
