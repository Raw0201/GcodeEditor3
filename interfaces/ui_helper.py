...
################################################################################
## Form generated from reading UI file 'helperJjaumR.ui'
##
...
class Ui_frm_helper(object):
    def setupUi(self, frm_helper):
        if not frm_helper.objectName():
            frm_helper.setObjectName("frm_helper")
    ...
    def retranslateUi(self, frm_helper):
        frm_helper.setWindowTitle(
            QCoreApplication.translate("frm_helper", "Ventana de ayuda", None)
        )
