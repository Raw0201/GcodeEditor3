...
class Ui_frm_subroutine(object):
    def setupUi(self, frm_subroutine):
        if not frm_subroutine.objectName():
            frm_subroutine.setObjectName("frm_subroutine")
    ...
    def retranslateUi(self, frm_subroutine):
        frm_subroutine.setWindowTitle(
            QCoreApplication.translate("frm_subroutine", "GCode Editor", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_sub.setToolTip(
            QCoreApplication.translate(
                "frm_subroutine", "Digite el n\u00famero de subrutina", None
            )
        )
        ...
        self.lbl_sub.setText(
            QCoreApplication.translate("frm_subroutine", "Subrutina", None)
        )
        self.lbl_rep.setText(
            QCoreApplication.translate(
                "frm_subroutine", "Cantidad de repeticiones", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.btn_save.setToolTip(
            QCoreApplication.translate(
                "frm_subroutine", "Agregar los datos al programa CNC", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.btn_save.setText(
            QCoreApplication.translate("frm_subroutine", "Agregar", None)
        )
        # if QT_CONFIG(shortcut)
        self.btn_save.setShortcut(
            QCoreApplication.translate("frm_subroutine", "Ctrl+S", None)
        )
        # endif // QT_CONFIG(shortcut)
        # if QT_CONFIG(tooltip)
        self.tbx_rep.setToolTip(
            QCoreApplication.translate(
                "frm_subroutine", "Digite la cantidad de repeticiones", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        # endif // QT_CONFIG(statustip)
        self.tbx_rep.setText(QCoreApplication.translate("frm_subroutine", "0", None))
        self.tbx_rep.setPlaceholderText("")
        self.lbl_com.setText(
            QCoreApplication.translate("frm_subroutine", "Compensaci\u00f3n", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_com.setToolTip(
            QCoreApplication.translate(
                "frm_subroutine", "Largo en subrutina menos largo pieza", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        # endif // QT_CONFIG(statustip)
        self.tbx_com.setText(QCoreApplication.translate("frm_subroutine", "0", None))
        self.tbx_com.setPlaceholderText("")
        self.btn_help.setText("")
        # if QT_CONFIG(shortcut)
        self.btn_help.setShortcut(
            QCoreApplication.translate("frm_subroutine", "F1", None)
        )
