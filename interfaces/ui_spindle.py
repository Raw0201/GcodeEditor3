...
class Ui_frm_spindle(object):
    def setupUi(self, frm_spindle):
        if not frm_spindle.objectName():
            frm_spindle.setObjectName("frm_spindle")
        ...
        self.tbx_spd.setObjectName("tbx_spd")
    ...
    def retranslateUi(self, frm_spindle):
        frm_spindle.setWindowTitle(
            QCoreApplication.translate("frm_spindle", "GCode Editor", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_spd.setToolTip(
            QCoreApplication.translate(
                "frm_spindle", "Digite la velocidad de giro", None
            )
        )
        ...
        self.lbl_spd.setText(
            QCoreApplication.translate("frm_spindle", "Velocidad de giro", None)
        )
        self.lbl_sde.setText(
            QCoreApplication.translate("frm_spindle", "Husillo de trabajo", None)
        )
        # if QT_CONFIG(tooltip)
        self.cbx_sde.setToolTip(
            QCoreApplication.translate(
                "frm_spindle", "Seleccione el husillo de trabajo a utilizar", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        self.btn_save.setToolTip(
            QCoreApplication.translate(
                "frm_spindle", "Agregar los datos al programa CNC", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.btn_save.setText(
            QCoreApplication.translate("frm_spindle", "Agregar", None)
        )
        # if QT_CONFIG(shortcut)
        self.btn_save.setShortcut(
            QCoreApplication.translate("frm_spindle", "Ctrl+S", None)
        )
        # endif // QT_CONFIG(shortcut)
        # if QT_CONFIG(tooltip)
        self.cbx_rot.setToolTip(
            QCoreApplication.translate(
                "frm_spindle", "Seleccione el sentido de giro del husillo", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.lbl_rot.setText(
            QCoreApplication.translate("frm_spindle", "Sentido de giro", None)
        )
        self.btn_help.setText("")
        # if QT_CONFIG(shortcut)
        self.btn_help.setShortcut(QCoreApplication.translate("frm_spindle", "F1", None))
