...
class Ui_frm_csink(object):
    def setupUi(self, frm_csink):
        if not frm_csink.objectName():
            frm_csink.setObjectName("frm_csink")
    ...
    def retranslateUi(self, frm_csink):
        frm_csink.setWindowTitle(
            QCoreApplication.translate("frm_csink", "GCode Editor", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_lgt.setToolTip(
            QCoreApplication.translate(
                "frm_csink", "Digite la longitud del avell\u00e1n", None
            )
        )
        ...
        self.lbl_lgt.setText(
            QCoreApplication.translate("frm_csink", "Longitud del avell\u00e1n", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_dim.setToolTip(
            QCoreApplication.translate(
                "frm_csink", "Digite el di\u00e1metro del agujero a avellanar", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.lbl_dim.setText(
            QCoreApplication.translate("frm_csink", "Di\u00e1metro a avellanar", None)
        )
        # if QT_CONFIG(tooltip)
        self.btn_save.setToolTip(
            QCoreApplication.translate(
                "frm_csink", "Agregar los datos al programa CNC", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        # endif // QT_CONFIG(statustip)
        self.btn_save.setText(QCoreApplication.translate("frm_csink", "Agregar", None))
        # if QT_CONFIG(shortcut)
        self.btn_save.setShortcut(
            QCoreApplication.translate("frm_csink", "Ctrl+S", None)
        )
        # endif // QT_CONFIG(shortcut)
        self.lbl_fed.setText(
            QCoreApplication.translate("frm_csink", "Avance de corte", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_fed.setToolTip(
            QCoreApplication.translate(
                "frm_csink", "Digite la velocidad de avance de corte", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        # endif // QT_CONFIG(statustip)
        self.tbx_fed.setText(QCoreApplication.translate("frm_csink", ".003", None))
        self.tbx_fed.setPlaceholderText("")
        # if QT_CONFIG(tooltip)
        self.cbx_sde.setToolTip(
            QCoreApplication.translate(
                "frm_csink", "Seleccione el husillo de trabajo a utilizar", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.lbl_sde.setText(
            QCoreApplication.translate("frm_csink", "Husillo de trabajo", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_xin.setToolTip(
            QCoreApplication.translate(
                "frm_csink", "Digite la posici\u00f3n de inicio en el eje X", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        # endif // QT_CONFIG(statustip)
        self.tbx_xin.setText(QCoreApplication.translate("frm_csink", "0.0", None))
        self.tbx_xin.setPlaceholderText("")
        self.lbl_xin.setText(
            QCoreApplication.translate("frm_csink", "Posici\u00f3n inicio X", None)
        )
        self.lbl_yin.setText(
            QCoreApplication.translate("frm_csink", "Posici\u00f3n inicio Y", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_yin.setToolTip(
            QCoreApplication.translate(
                "frm_csink", "Digite la posici\u00f3n de inicio en el eje Y", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        # endif // QT_CONFIG(statustip)
        self.tbx_yin.setText(QCoreApplication.translate("frm_csink", "0.0", None))
        self.tbx_yin.setPlaceholderText("")
        self.lbl_zin.setText(
            QCoreApplication.translate("frm_csink", "Posici\u00f3n inicio Z", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_zin.setToolTip(
            QCoreApplication.translate(
                "frm_csink", "Digite la posici\u00f3n de inicio en el eje Z", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        # endif // QT_CONFIG(statustip)
        self.tbx_zin.setText(QCoreApplication.translate("frm_csink", "0.0", None))
        self.tbx_zin.setPlaceholderText("")
        # if QT_CONFIG(tooltip)
        self.cbx_sys.setToolTip(
            QCoreApplication.translate(
                "frm_csink", "Seleccione el sistema de coordenadas a utilizar", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.lbl_sys.setText(
            QCoreApplication.translate("frm_csink", "Sistema de coordenadas", None)
        )
        self.lbl_znd.setText(
            QCoreApplication.translate("frm_csink", "Posici\u00f3n de salida", None)
        )
        # if QT_CONFIG(tooltip)
        self.cbx_znd.setToolTip(
            QCoreApplication.translate(
                "frm_csink", "Seleccione el punto de salida del avellanado", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        self.tbx_rtr.setToolTip(
            QCoreApplication.translate(
                "frm_csink", "Digite la distancia de retracci\u00f3n", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        # endif // QT_CONFIG(statustip)
        self.tbx_rtr.setText(QCoreApplication.translate("frm_csink", "0.0", None))
        self.tbx_rtr.setPlaceholderText("")
        self.lbl_rtr.setText(
            QCoreApplication.translate("frm_csink", "Punto de retracci\u00f3n", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_ang.setToolTip(
            QCoreApplication.translate(
                "frm_csink",
                "Digite el \u00e1ngulo total (incluido) del avell\u00e1n",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        # endif // QT_CONFIG(statustip)
        self.tbx_ang.setText(QCoreApplication.translate("frm_csink", "90", None))
        self.tbx_ang.setPlaceholderText("")
        self.lbl_ang.setText(
            QCoreApplication.translate(
                "frm_csink", "\u00c1ngulo del avell\u00e1n", None
            )
        )
        self.lbl_dwl.setText(
            QCoreApplication.translate("frm_csink", "Tiempo de espera", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_dwl.setToolTip(
            QCoreApplication.translate(
                "frm_csink",
                "Digite el tiempo de espera en segundos para pulir el fondo del avell\u00e1n",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        # endif // QT_CONFIG(statustip)
        self.tbx_dwl.setText(QCoreApplication.translate("frm_csink", "0.0", None))
        self.tbx_dwl.setPlaceholderText("")
        self.btn_help.setText("")
        # if QT_CONFIG(shortcut)
        self.btn_help.setShortcut(QCoreApplication.translate("frm_csink", "F1", None))
