...
################################################################################
## Form generated from reading UI file 'cutoffMGrihi.ui'
##
...
class Ui_frm_cutoff(object):
    def setupUi(self, frm_cutoff):
        if not frm_cutoff.objectName():
            frm_cutoff.setObjectName("frm_cutoff")
    ...
    def retranslateUi(self, frm_cutoff):
        frm_cutoff.setWindowTitle(
            QCoreApplication.translate("frm_cutoff", "GCode Editor", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_dia.setToolTip(
            QCoreApplication.translate(
                "frm_cutoff",
                "Digite la dimensi\u00f3n del di\u00e1metro a tronzar",
                None,
            )
        )
        ...
        self.lbl_dia.setText(
            QCoreApplication.translate("frm_cutoff", "Di\u00e1metro a tronzar", None)
        )
        # if QT_CONFIG(tooltip)
        self.btn_save.setToolTip(
            QCoreApplication.translate(
                "frm_cutoff", "Agregar los datos al programa CNC", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        # endif // QT_CONFIG(statustip)
        self.btn_save.setText(QCoreApplication.translate("frm_cutoff", "Agregar", None))
        # if QT_CONFIG(shortcut)
        self.btn_save.setShortcut(
            QCoreApplication.translate("frm_cutoff", "Ctrl+S", None)
        )
        # endif // QT_CONFIG(shortcut)
        self.lbl_cfr.setText(
            QCoreApplication.translate("frm_cutoff", "Dimensi\u00f3n del bisel", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_cfr.setToolTip(
            QCoreApplication.translate(
                "frm_cutoff", "Digite la dimensi\u00f3n del bisel", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        # if QT_CONFIG(shortcut)
        self.btn_help.setShortcut(QCoreApplication.translate("frm_cutoff", "F1", None))
