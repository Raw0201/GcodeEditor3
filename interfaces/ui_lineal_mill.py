...
################################################################################
## Form generated from reading UI file 'lineal_millMGVuKJ.ui'
##
...
class Ui_frm_lineal_mill(object):
    def setupUi(self, frm_lineal_mill):
        if not frm_lineal_mill.objectName():
            frm_lineal_mill.setObjectName("frm_lineal_mill")
    ...
    def retranslateUi(self, frm_lineal_mill):
        frm_lineal_mill.setWindowTitle(
            QCoreApplication.translate("frm_lineal_mill", "GCode Editor", None)
        )
        ...
        self.lbl_xin.setText(
            QCoreApplication.translate("frm_lineal_mill", "Movimiento eje X", None)
        )
        # if QT_CONFIG(tooltip)
        self.btn_save.setToolTip(
            QCoreApplication.translate(
                "frm_lineal_mill", "Agregar los datos al programa CNC", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.btn_save.setText(
            QCoreApplication.translate("frm_lineal_mill", "Agregar", None)
        )
        # if QT_CONFIG(shortcut)
        self.btn_save.setShortcut(
            QCoreApplication.translate("frm_lineal_mill", "Ctrl+S", None)
        )
        # endif // QT_CONFIG(shortcut)
        self.lbl_mov.setText(
            QCoreApplication.translate("frm_lineal_mill", "Tipo de movimiento", None)
        )
        # if QT_CONFIG(tooltip)
        self.cbx_mov.setToolTip(
            QCoreApplication.translate(
                "frm_lineal_mill", "Seleccione el tipo de movimiento a ejecutar", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        ...
        self.lbl_zin.setText(
            QCoreApplication.translate("frm_lineal_mill", "Movimiento eje Z", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_fed.setToolTip(
            QCoreApplication.translate(
                "frm_lineal_mill", "Digite la velocidad de avance de corte", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.lbl_fed.setText(
            QCoreApplication.translate("frm_lineal_mill", "Avance de corte", None)
        )
        # if QT_CONFIG(tooltip)
        self.btn_switch.setToolTip(
            QCoreApplication.translate(
                "frm_lineal_mill", "Cambia a la funci\u00f3n indicada", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.btn_switch.setText(
            QCoreApplication.translate(
                "frm_lineal_mill", "Cambiar a Fresado radial", None
            )
        )
        # if QT_CONFIG(shortcut)
        self.btn_switch.setShortcut(
            QCoreApplication.translate("frm_lineal_mill", "Ctrl+Q", None)
        )
        # endif // QT_CONFIG(shortcut)
        # if QT_CONFIG(tooltip)
        ...
        self.lbl_yin.setText(
            QCoreApplication.translate("frm_lineal_mill", "Movimiento eje Y", None)
        )
        # if QT_CONFIG(tooltip)
        ...
        self.lbl_sys.setText(
            QCoreApplication.translate(
                "frm_lineal_mill", "Sistema de coordenadas", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.cbx_com.setToolTip(
            QCoreApplication.translate(
                "frm_lineal_mill",
                "Seleccione el sentido de la compensaci\u00f3n de herramienta",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.lbl_com.setText(
            QCoreApplication.translate(
                "frm_lineal_mill", "Compensaci\u00f3n de hta", None
            )
        )
        self.lbl_rep.setText(
            QCoreApplication.translate(
                "frm_lineal_mill", "Cantidad de repeticiones", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.tbx_rep.setToolTip(
            QCoreApplication.translate(
                "frm_lineal_mill", "Digite la cantidad de repeticiones", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.btn_help.setShortcut(
            QCoreApplication.translate("frm_lineal_mill", "F1", None)
        )
