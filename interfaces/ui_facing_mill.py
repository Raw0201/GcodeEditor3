...
class Ui_frm_facing_mill(object):
    def setupUi(self, frm_facing_mill):
        if not frm_facing_mill.objectName():
            frm_facing_mill.setObjectName("frm_facing_mill")
    ...
    def retranslateUi(self, frm_facing_mill):
        frm_facing_mill.setWindowTitle(
            QCoreApplication.translate("frm_facing_mill", "GCode Editor", None)
        )
        # if QT_CONFIG(tooltip)
        self.tbx_wdt.setToolTip(
            QCoreApplication.translate(
                "frm_facing_mill", "Digite el texto del comentario", None
            )
        )
        ...
        self.lbl_wdt.setText(
            QCoreApplication.translate("frm_facing_mill", "Ancho a refrentar", None)
        )
        self.lbl_dir.setText(
            QCoreApplication.translate(
                "frm_facing_mill", "Direcci\u00f3n de los cortes", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.cbx_dir.setToolTip(
            QCoreApplication.translate(
                "frm_facing_mill", "Seleccione el husillo de trabajo a utilizar", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        self.btn_save.setToolTip(
            QCoreApplication.translate(
                "frm_facing_mill", "Agregar los datos al programa CNC", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(statustip)
        ...
        self.btn_save.setText(
            QCoreApplication.translate("frm_facing_mill", "Agregar", None)
        )
        # if QT_CONFIG(shortcut)
        self.btn_save.setShortcut(
            QCoreApplication.translate("frm_facing_mill", "Ctrl+S", None)
        )
        # endif // QT_CONFIG(shortcut)
        # if QT_CONFIG(tooltip)
        ...
        self.lbl_lgt.setText(
            QCoreApplication.translate("frm_facing_mill", "Longitud a refrentar", None)
        )
        # if QT_CONFIG(tooltip)
        ...
        self.lbl_cut.setText(
            QCoreApplication.translate("frm_facing_mill", "Profundidad por corte", None)
        )
        # if QT_CONFIG(tooltip)
        ...
        self.lbl_fed.setText(
            QCoreApplication.translate("frm_facing_mill", "Avance de corte", None)
        )
        # if QT_CONFIG(tooltip)
        ...
        # endif // QT_CONFIG(statustip)
        self.tbx_lcm.setText(QCoreApplication.translate("frm_facing_mill", "0.0", None))
        self.tbx_lcm.setPlaceholderText("")
        self.lbl_lcm.setText(
            QCoreApplication.translate(
                "frm_facing_mill", "Compensaci\u00f3n longitudinal", None
            )
        )
        # if QT_CONFIG(tooltip)
        ...
        # endif // QT_CONFIG(statustip)
        self.tbx_tcm.setText(QCoreApplication.translate("frm_facing_mill", "0.0", None))
        self.tbx_tcm.setPlaceholderText("")
        self.lbl_tcm.setText(
            QCoreApplication.translate(
                "frm_facing_mill", "Compensaci\u00f3n trasversal", None
            )
        )
        self.btn_help.setText("")
        # if QT_CONFIG(shortcut)
        self.btn_help.setShortcut(
            QCoreApplication.translate("frm_facing_mill", "F1", None)
        )
