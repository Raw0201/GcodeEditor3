...
def load_menu_actions(window):
    ...
    window.actionGraph.triggered.connect(
        lambda: graph_window(window, window.config_list)
    )
    ...
    window.actionG_invert.triggered.connect(lambda: gcode_mod(window, "Mov"))
    window.actionSubrut_up.triggered.connect(lambda: param_mod(window, "Sub", 1.0))
    window.actionSubrut_down.triggered.connect(lambda: param_mod(window, "Sub", -1.0))
    window.actionLoop_up.triggered.connect(lambda: param_mod(window, "Rep", 1.0))
    window.actionLoop_down.triggered.connect(lambda: param_mod(window, "Rep", -1.0))
    window.actionX_invert.triggered.connect(lambda: param_invert(window, "Xin"))
    window.actionY_invert.triggered.connect(lambda: param_invert(window, "Yin"))
    window.actionZ_invert.triggered.connect(lambda: param_invert(window, "Zin"))
    window.actionI_invert.triggered.connect(lambda: param_invert(window, "Xcn"))
    window.actionJ_invert.triggered.connect(lambda: param_invert(window, "Ycn"))
    window.actionK_invert.triggered.connect(lambda: param_invert(window, "Zcn"))
    window.actionS1_move.triggered.connect(lambda: side_changer(window, "$1"))
    window.actionS2_move.triggered.connect(lambda: side_changer(window, "$2"))
    window.actionS3_move.triggered.connect(lambda: side_changer(window, "$3"))
    window.actionX_up.triggered.connect(lambda: param_mod(window, "Xin", 0.001))
    window.actionX_down.triggered.connect(lambda: param_mod(window, "Xin", -0.001))
    window.actionY_up.triggered.connect(lambda: param_mod(window, "Yin", 0.001))
    window.actionY_down.triggered.connect(lambda: param_mod(window, "Yin", -0.001))
    window.actionZ_up.triggered.connect(lambda: param_mod(window, "Zin", 0.001))
    window.actionZ_down.triggered.connect(lambda: param_mod(window, "Zin", -0.001))
    window.actionI_up.triggered.connect(lambda: param_mod(window, "Xcn", 0.001))
    window.actionI_down.triggered.connect(lambda: param_mod(window, "Xcn", -0.001))
    window.actionJ_up.triggered.connect(lambda: param_mod(window, "Ycn", 0.001))
    window.actionJ_down.triggered.connect(lambda: param_mod(window, "Ycn", -0.001))
    window.actionK_up.triggered.connect(lambda: param_mod(window, "Zcn", 0.001))
    window.actionK_down.triggered.connect(lambda: param_mod(window, "Zcn", -0.001))
    window.actionFeed_up.triggered.connect(lambda: param_mod(window, "Fed", 0.001))
    window.actionFeed_down.triggered.connect(lambda: param_mod(window, "Fed", -0.001))
    window.actionSpeed_up.triggered.connect(lambda: param_mod(window, "Spd", 100.0))
    window.actionSpeed_down.triggered.connect(lambda: param_mod(window, "Spd", -100.0))
