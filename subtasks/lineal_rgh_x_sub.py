...
from subtasks.generators.lineal_rgh_x_sub_gen import lineal_rgh_x_sub_gen


class Lineal_rgh_x_sub(QMainWindow):
    def __init__(self, main_window):
        super().__init__()
        self.window = main_window
        self.task = sub_tasks.tasks_list["Lineal_rgh_x_sub"]["Description"]
