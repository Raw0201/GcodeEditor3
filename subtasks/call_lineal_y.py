...
from subtasks.generators.call_lineal_y_gen import call_lineal_y_gen
from interfaces.ui_call_lineal import Ui_frm_call_lineal


class Call_lineal_y(Subtask, Ui_frm_call_lineal):
    def __init__(self, main_window):
        super().__init__()
        self.window = main_window
        self.task = sub_tasks.tasks_list["Call_lineal_y"]["Description"]
    ...
    def collector(self):
        ...
        data = {
            ...
            "Mtx": self.window.lineal_matrix_y,
            "Blk": False,
        }
    ...
    def generator(self, machine: str, data: dict) -> list:
        ...
        data["Mtx"] = self.lineal_matrix_y

        return call_lineal_y_gen(machine, data)
